...
{
    public class TipBodyLoginReply : TipBodyBase
    {
        #region 属性
        /// <summary>
        /// 协议数据头
        ...
        public TipBodyLoginReply(string hexString) : base(hexString) { }

        /// <summary>
        /// 用给定的byte数组初始化
        /// </summary>
        /// <param name="bytes"></param>
        public TipBodyLoginReply(byte[] bytes) : base(bytes) { }
        #endregion
        ...
        {
            TipHead.UpdateTipCode(TipCode.LoginReply);
        }
        #endregion
    }
}
