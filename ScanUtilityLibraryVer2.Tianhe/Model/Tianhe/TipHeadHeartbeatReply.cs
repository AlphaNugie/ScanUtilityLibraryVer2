...
namespace ScanUtilityLibrary.Tianhe.Model.Tianhe
{
    ...
    /// TIP数据头
    /// </summary>
    public class TipHeadHeartbeatReply : TipHeadBase
    {
        #region 属性
        #endregion
        ...
        public TipHeadHeartbeatReply(string hexString) : base(hexString, StreamDirection.FromDevice) { }

        /// <summary>
        /// 用给定的byte数组初始化
        /// </summary>
        /// <param name="bytes">报文的字节流</param>
        public TipHeadHeartbeatReply(byte[] bytes) : base(bytes, StreamDirection.FromDevice) { }
        #endregion
