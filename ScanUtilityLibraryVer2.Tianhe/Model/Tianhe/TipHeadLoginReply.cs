...
{
    public class TipHeadLoginReply : TipHeadBase
    {
        #region 属性
        #endregion
        ...
        public TipHeadLoginReply(string hexString) : base(hexString, StreamDirection.FromDevice) { }

        /// <summary>
        /// 用给定的byte数组初始化
        /// </summary>
        /// <param name="bytes">报文的字节流</param>
        public TipHeadLoginReply(byte[] bytes) : base(bytes, StreamDirection.FromDevice) { }
        #endregion
